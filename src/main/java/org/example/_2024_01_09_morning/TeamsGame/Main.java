...
//        Команды с победами над определенной командой: Определить команды, которые выиграли у заданной команды.
        Streams.winnersTeams(fullAdultTeamResults, Generator.getRandomTeam(adultTeams));
        Streams.winnersTeams(fullTeenAgerTeamResults, Generator.getRandomTeam(teenAgerTeams));
        Streams.winnersTeams(fullPupilTeams, Generator.getRandomTeam(pupilTeams));
